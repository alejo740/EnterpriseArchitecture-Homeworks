...
public class Application {
    public static void main(String[] args) {
        ...
        ICalculator remoteCalculator = context.getBean("calculatorHttpInvokerProxy", ICalculator.class);
        int resultCalc = remoteCalculator.calc('+', 1);
        System.out.println("Calculator result: " + resultCalc);
    }
}
